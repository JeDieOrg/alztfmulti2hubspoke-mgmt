...
*/
starter_locations = ["germanywestcentral", "westeurope"]
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "identity-tf-hubspoke-multi2"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "connectivity-tf-hubspoke-multi2"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "management-tf-hubspoke-multi2"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "security-tf-hubspoke-multi2"
    }
  }
  policy_assignments_to_modify = {
    alz-tf-hubspoke-multi2 = {
      policy_assignments = {
